...
Includes PII-returning endpoint for Camp 3 I/O Security demonstration.
...
app = FastAPI(
    title="Trail API",
    description="REST API for mountain trail information and permit management. Includes PII demonstration endpoint for Camp 3.",
    version="1.0.0"
)
...
async def root():
    ...
    return {
        ...
        "security_note": "The /permits/{id}/holder endpoint returns PII for Camp 3 demonstration. APIM output sanitization should redact sensitive data."
    }
