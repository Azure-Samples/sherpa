...
- :material-router:{ .lg .middle } __API Management Gateway__

    ---

    Centralize MCP traffic through a single, secure access point

- :material-lan-disconnect:{ .lg .middle } __Network Isolation__

    ---

    Use Private Endpoints to keep MCP servers off the public internet

- :material-library:{ .lg .middle } __API Center Governance__

    ---

    Catalog and govern all MCP servers in your organization

- :material-speedometer:{ .lg .middle } __Rate Limiting__
...
← [Camp 1: Identity](camp1-identity.md) | [Camp 3: I/O Security](camp3-io-security.md) →
